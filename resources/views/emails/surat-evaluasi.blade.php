...
@endphp
    ...
    <div class="body">
        ...
        <p class="greeting">
            ...
            Dengan hormat,<br><br>
            Terlampir adalah <strong>Lembar Evaluasi Kegiatan Magang/PKL</strong> Anda selama di
            <strong>Pusat Data dan Teknologi Informasi, Kementerian Pekerjaan Umum</strong>.
            Lembar evaluasi ini merupakan penilaian resmi atas kinerja Anda selama menjalani program magang.
        </p>
        ...
        <p style="font-size: 13px; color: #333; line-height: 1.7;">
            Terima kasih atas kontribusi Anda selama masa magang.
            Semoga pengalaman dan ilmu yang didapatkan dapat bermanfaat untuk karir Anda di masa depan.
        </p>
        ...
        <div class="attachment-note">
            ...
            <div class="attachment-text">
                <strong>Lembar Evaluasi Magang Terlampir</strong>
                <span>Mohon disimpan sebagai dokumentasi resmi hasil penilaian magang Anda.</span>
            </div>
        </div>
